...
function CtDAO() {
	...
	this.HTTP_URL_PREFIX =
			"http://" + window.location.host + "/" + this.CONTEXT_NAME + "/";
	this.HTTPS_URL_PREFIX =
			"https://" + window.location.host + "/" + this.CONTEXT_NAME + "/";
	this.API_PREFIX = this.HTTP_URL_PREFIX + "travelapi";

	this.GET_CONSUMER_PROFILE_DETAILS =
			this.API_PREFIX + "/consumer/getprofile.json";
	this.GET_CONSUMER_CALLBACK_DETAILS =
			this.API_PREFIX + "/consumer/getcallbacksdetails.json";
	this.GET_MY_TARVELS = this.API_PREFIX + "/consumer/getmytravels.json";
	this.GET_DELETE_TRIP_IMAGE_URL =
			this.API_PREFIX + "/vendor/deleteTripImage.json";
	this.GET_TRIPDETAILS_UPDATE_STATUS_URL =
			this.API_PREFIX + "/trip/updateTripDetailStatus.json";
	this.ADD_TRIP_COMMENTS = this.API_PREFIX + "/trip/addComments.json";
	this.GET_TRIP_COMMENTS_PAGENO = this.API_PREFIX + "/trip/getCommentsPagno.json";
...
CtDAO.prototype.getData =
		function(url, postParams, callback, isCacheMap, isParse) {
