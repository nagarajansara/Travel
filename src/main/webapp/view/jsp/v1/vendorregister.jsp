...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/travel/theme/dashboard/css/bootstrap.min.css" />
		<link rel="stylesheet" href="/travel/theme/dashboard/css/font-awesome.css" />
		<link rel="stylesheet" href="/travel/theme/dashboard/css/icheck/flat/blue.css" />
					...
					<div class="col-xs-12 col-sm-8">
									...
									<div class="col-xs-12">
										<c:choose>
										    ...
										    <c:otherwise>
										        <div class="alert alert-danger">
													<button data-dismiss="alert" class="close">×</button>
													<strong></strong><c:out value="${(model.responseMsg)}" />
												</div>
										    </c:otherwise>
										</c:choose>
									</div>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="/travel/travelapi/login/vendorregister" name="basic_validate" id="basic_validate" novalidate="novalidate">
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label">Name of organization</label>
										<div class="col-sm-9 col-md-9 col-lg-5">
											<input type="text" class="form-control input-sm" name="nameoforganization" id="nameoforganization">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9 col-md-9 col-lg-6">
											<textarea name="ctAddress" id="ctAddress" class="form-control" rows="2"></textarea>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label">PAN Card</label>
										<div class="col-sm-9 col-md-9 col-lg-5">
