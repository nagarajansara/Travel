<!--// Footer //-->
    ...
    <div id="copyright">
      <div class="container">
        <div class="row">
          <div class="col-md-6"><p>© Copyright 2014 All Rights Reserved by KodeForest</p></div>
          <div class="col-md-6">
    ...
    <script src="/travel/theme/js/jquery.js"></script>
    <script src="/travel/theme/js/bootstrap.min.js"></script>
    <script src="/travel/theme/js/jquery.bxslider.min.js"></script>
    <script src="/travel/theme/js/bootstrap-datepicker.js"></script>
    <script src="/travel/theme/js/waypoints-min.js"></script>
    <script src="/travel/theme/js/functions.js"></script>
    <script src="https://apis.google.com/js/plusone.js" type="text/javascript" gapi_processed="true"></script>
    <script src="/travel/theme/plugin/datepicker/tsdatepicker.js"></script>
    <script src="/travel/theme/plugin/alert/sweetalert.min.js"></script>
    <script src="/travel/theme/plugin/alert/sweetalert.min.js"></script>
  </body>