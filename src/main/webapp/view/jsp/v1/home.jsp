...
<div id="mainbanner">
	...
	<!--<div class="kd-tourform" style="display: none">
		<div class="container">
			...
			<form>
				<ul>
					<li class="tsDefaultSearchFontStyle"><select
						class="ctCityNames">

					</select></li>
					<li class="tsDefaultSearchFontStyle">
						<div
							class="input-group input-append date tsDefaultSearchFontStyle"
							id="datePicker">
					...
					<li><input type="submit" class="thbg-color tsHomeSearchBtn"
						value="search now"></li>
				</ul>
			</form>
		</div>
					...
					<div class="kd-package-list">
						<div class="row">
							...
							<article class="col-md-4">
								<figure>
									<a href="#"><img
										src="${baseURL}/theme/extraimages/pakege4.jpg" alt=""></a>
									<figcaption>
										<span class="package-price thbg-color">$7,600</span>
										<div class="kd-bottomelement">
											<h5>
