					...
					<div class="col-xs-12 col-sm-8">
						...
						<c:if test="${not empty model.responseStatus}">
							...
							<c:if test="${model.responseStatus eq 200}">
								<c:redirect url="/travel/view/jsp/v1/home.jsp"/>
							</c:if>
						</c:if>	
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="/travel/travelapi/login/customerregister" name="basic_validate" id="basic_validate" novalidate="novalidate">
